# Admin Web Local Auth Specification

## Purpose

Define local-only mock authentication behavior for `admin-web` while preserving real Cognito behavior as the default authentication path.
